...
extension MessageModelQueryWhere
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> orderIdEqualTo(
      String orderId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'orderId',
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> orderIdNotEqualTo(
      String orderId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension MessageModelQuerySortBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByOrderId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderId', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByOrderIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQuerySortThenBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByOrderId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderId', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByOrderIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderId', Sort.desc);
    });
  }
...
extension MessageModelQueryWhereDistinct
  ...
  QueryBuilder<MessageModel, MessageModel, QDistinct> distinctByOrderId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQueryProperty
  ...
  QueryBuilder<MessageModel, String, QQueryOperations> orderIdProperty() {
    return QueryBuilder.apply(this, (query) {
